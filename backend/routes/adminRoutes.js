...
// GET user by ID (recruiter/admin/superadmin) – for viewing applicant profile when not populated
router.get('/users/:id', authorizeRoles('recruiter', 'admin', 'superadmin'), async (req, res) => {
  try {
    const { id } = req.params;
