    ...
    const loadData = async () => {
      ...
      try {
        ...
        jobsRes.data.forEach((job: Job) => {
          if (job.location) {
            // Extract country from location (e.g., "Munich, DE" -> "DE")
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 dark:text-slate-400">Tüm iş ilanlarını görüntüle</p>
              </div>
            </Link>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 mt-4 pt-4 border-t border-slate-200 dark:border-slate-700">
                    <span className="text-xs text-slate-500 dark:text-slate-500">
                      {t('employerDashboard.viewDetails')}
                    </span>
                    <span className="text-brandOrange group-hover:translate-x-1 transition-transform">
                      →
                    </span>
                  </div>
                </Link>
